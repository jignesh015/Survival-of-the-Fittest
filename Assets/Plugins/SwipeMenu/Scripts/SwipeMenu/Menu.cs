	...
	public class Menu : MonoBehaviour
	{
		...
		void Update ()
		{
            ...
            if (SceneManager.GetActiveScene().buildIndex == 1)
            {
                ...
                {
                    case 0:
                        currentAnimal.text = "Bear";
                        break;
                    case 1:
                        currentAnimal.text = "Lion";
                        break;
                    case 2:
                        currentAnimal.text = "Polar Bear";
                        break;
                }
            }
            ...
            if (SceneManager.GetActiveScene().buildIndex == 2)
            {
                ...
                {
                    case 0:
                        currentEnvironment.text = "Forest";
                        break;
                    case 1:
                        currentEnvironment.text = "Savannah";
                        break;
                    case 2:
                        currentEnvironment.text = "Polar";
                        break;
                }
            }
